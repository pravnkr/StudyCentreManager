...
<body>
	...
	<h2>IgnouBadhega - Delete an existing Student By Enrollment No</h2>

	<form:form
		action="${pageContext.request.contextPath}/coordinator/delete-student/by-enroll/fetch"
	...
	<c:if test="${recordFetchedByEnroll || inputError}">
		...
		<form:form
			action="${pageContext.request.contextPath}/coordinator/delete-student/by-enroll/save"
