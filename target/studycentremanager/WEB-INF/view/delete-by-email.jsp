...
<body>
	...
	<form:form
		action="${pageContext.request.contextPath}/coordinator/delete-student/by-email/fetch"
	...
	<c:if test="${recordFetchedByEmail || inputError}">
		...
		<form:form
			action="${pageContext.request.contextPath}/coordinator/delete-student/by-email/save"
